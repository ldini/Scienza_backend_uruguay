...
public class PasswordRecoveryController {
	...
	public @ResponseBody ResponseDto revocerPassword(
		...
		PasswordRecoveryResponseDto response = null;
		...
		try
		{
			...
			response = this.passwordRecoveryService.recoverPassword(request, token, sapId, deviceType);
		}
